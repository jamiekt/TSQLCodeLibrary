...
create view jt.vwdiskfileLatency
AS
/*
...
--Syntax Error: The ORDER BY clause is not valid in views, inline functions, derived tables, sub-queries, and common table expressions, unless TOP or FOR XML or OFFSET is also specified.
--create view jt.vwdiskfileLatency
--AS
--/*
--	Show disk file latency
